...
export async function handler(
  ...
  if (hasStaticPaths && !isDraftMode) {
    ...
    const isPrerendered = prerenderManifest.routes[decodedPathname]
  ...
  try {
    ...
    const handleResponse = async (span?: Span) => {
      ...
      if (!result.value) {
        ...
        // TODO: should route-module itself handle rendering
        // the 404?
      ...
      if (
        ...
        (isErrorPage && getRequestMeta(req, 'minimalMode'))
      ) {
        return null
      }
